...
# // install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/${GitUser}/simple/main/badvpn-udpgw64"
...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/${GitUser}/simple/main/squid3.conf"
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/${GitUser}/simple/main/banner/bannerssh.conf"
...
wget -O user-list "https://raw.githubusercontent.com/${GitUser}/simple/main/user-list.sh"
wget -O user-lock "https://raw.githubusercontent.com/${GitUser}/simple/main/user-lock.sh"
wget -O user-unlock "https://raw.githubusercontent.com/${GitUser}/simple/main/user-unlock.sh"
wget -O user-password "https://raw.githubusercontent.com/${GitUser}/simple/main/user-password.sh"
wget -O antitorrent "https://raw.githubusercontent.com/${GitUser}/simple/main/antitorrent.sh"
