...
patchtls=/kontol-vmesswstls
patchnontls=/kontol-vmesswsntls
...
patchtls=/kontol-vlesswstls
patchnontls=/kontol-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/kontol-trojanwstls
patchnone=/kontol-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
