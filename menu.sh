...
echo -e " \e[$line └──────────────────────────────────────────────────────┘${NC}"
echo -e "  "
echo -e "    [\e[$number 01${NC}]${YLW} • Xray Menu ${NC}             [\e[$number 06${NC}]${YLW} • Themes ${NC}"
echo -e "    [\e[$number 02${NC}]${YLW} • SSH & OPENVPN ${NC}         [\e[$number 07${NC}]${YLW} • Change Port ${NC}"
echo -e "    [\e[$number 03${NC}]${YLW} • System Menu  ${NC}          [\e[$number 08${NC}]${YLW} • About Script ${NC}"
echo -e "    [\e[$number 04${NC}]${YLW} • Check Running ${NC}         [\e[$number 09${NC}]${YLW} • RAM Cleaner ${NC}"
echo -e "    [\e[$number 05${NC}]${YLW} • Reboot                  ${NC}"                
echo -e " "
echo -e " \e[$line ┌──────────────────────────────────────────────────────┐${NC}"
