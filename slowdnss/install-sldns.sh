...
sleep 1
echo -e "[ ${green}INFO${NC} ] Downloading files... "
wget -qc -O /etc/slowdns/sldns-server "https://raw.githubusercontent.com/Jesanne87/simple/main/slowdnss/sldns-server"
wget -qc -O /etc/slowdns/sldns-client "https://raw.githubusercontent.com/Jesanne87/simple/main/slowdnss/sldns-client"
sleep 1
